  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-blue-50 to-indigo-100 font-sans">
      ...
      <header className="bg-white py-3 relative shadow-md">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-3 mb-3 text-center max-w-4xl mx-auto">
            <h2 className="text-xl font-bold mb-1 text-indigo-600">Prepárate para tu próxima entrevista</h2>
      ...
      <main className="container mx-auto px-4 py-4 max-w-4xl">
        ...
        <div className="mb-4 bg-indigo-600 p-4 rounded-xl shadow-xl transform transition-transform duration-300 hover:scale-[1.01]">
          ...
          <div className="bg-white p-3 rounded-xl shadow-md border border-indigo-100">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <span className="bg-indigo-600 text-white h-6 w-6 rounded-full flex items-center justify-center mr-2 shadow-sm text-xs">1</span>
        ...
        <section className="mb-6">
          <h2 className="text-lg font-bold mb-3 text-gray-800 flex items-center">
            ...
            <span className="relative">
              ...
              <span className="absolute -top-1 -right-20 bg-indigo-500 text-white text-xs px-2 py-0.5 rounded-full animate-pulse">¡Nuevas!</span>
            </span>
          </h2>
